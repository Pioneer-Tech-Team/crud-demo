...
export const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center">
          <div>{data.company_group_name}</div>
        </div>
      )
    },
  },
            ...
            <DialogContent>
              <DialogHeader>
                ...
                Company
                    ...
                    <tbody>
                      <tr>
                        <td className="bg-orange-200 p-3 text-center text-black">Company</td>
                        <td className="text-black p-3 text-center">Tata Motors Ltd</td>
                      </tr>
                      <tr>
                        <td className="bg-orange-200 p-3 text-center text-black">PAN</td>
                        <td className="text-black p-3 text-center">ADGCF2896J</td>
                      </tr>
                      <tr>
                        <td className="bg-orange-200 p-3 text-center text-black">PAN Name</td>
                        <td className="text-black p-3 text-center">Tata Motors Ltd</td>
                      </tr>
                      <tr>
                        <td className="bg-orange-200 p-3 text-center text-black">Aadhar</td>
                        <td className="text-black p-3 text-center">256987452369</td>
                      </tr>
                      <tr>
                        <td className="bg-orange-200 p-3 text-center text-black">GSTIN</td>
                        <td className="text-black p-3 text-center">27ADGCF2896J1ZL</td>
                      </tr>
                      <tr>
